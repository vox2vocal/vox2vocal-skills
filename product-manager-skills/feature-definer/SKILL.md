...
description: Use to turn an approved or near-approved PRD into feature definitions with service surface, MVP scope, later scope, business rules, states, permissions, edge cases, and measurable behavior.
---
